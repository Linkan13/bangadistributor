   ...
   <div class="container banner-section-container mt-4">
    <div class="row">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="single-banner-item">
                        <img src="{{asset('frontend/default/img/banner/banner1.png')}}" class="w-100" alt="banner image">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-6">
                    <div class="single-banner-item">
                        <img src="{{asset('frontend/default/img/banner/banner2.png')}}" class="w-100" alt="banner image">
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="single-banner-item">
                        <img src="{{asset('frontend/default/img/banner/banner3.png')}}" class="w-100" alt="banner image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-4">
            <div class="single-banner-item">
                <img src="{{asset('frontend/default/img/banner/banner4.png')}}" class="w-100" alt="banner image">
            </div>
        </div>
    </div>
  </div>
...
<div class="flash-timer-and-button d-flex flex-wrap justify-content-between align-items-center">
    ...
    <div class="product-grid-with-sideAd">
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-12 mb-5 mb-lg-0 sideAd">
                <img src="{{asset('frontend/default/img/banner/banner5.png')}}" alt="iamge">
            </div>
  ...
  <div class="container my-5">
    <div class="row">
        <div class="col-12">
            <img src="{{asset('frontend/default/img/ad.png')}}" class="w-100" alt="">
        </div>
    </div>
  </div>
    ...
    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 mb-4 mb-xl-0">
        ...
        <div class="input-group news-letter-email">
          ...
          <div class="footer-payment-method-contaienr">
            <img src="{{asset('frontend/default/img/payment-method/payment-method-1.png')}}" class="payment-method-1" alt="payment method">
            <img src="{{asset('frontend/default/img/payment-method/payment-method-2.png')}}" class="payment-method-2" alt="payment method">
          </div>
