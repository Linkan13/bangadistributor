<div id="running_ready" class="amaz_section amaz_deal_area_running_ready mt_20 {{$ads->status == 0?'d-none':''}}">
	<div class="container ps_re">
		<div class="side_text">sportswear</div>
		<div class="row gap_0">
			<div class="col-xl-6 col-md-6 col-lg-6 col-xm-12 pr_0 ps_re">
	            <img class="img-fluid lazyload image_cover" src="{{showImage(@$ads->image)}}" alt="{{@$ads->title}}" title="{{@$ads->title}}">
				<div class="box-text">
					<h4 class="txt-1">Running</h4>
					<h4 class="txt-2">Regular fit fast dying</h4>
					<h4 class="txt-1">Ready</h4>
				</div>
			</div>
			<div class="col-xl-6 col-md-6 col-lg-6 col-xm-12 with_bg_right">
				<h3 class="sec_title">New product of store</h3>
				<p class="sec_desc">Tailor-made products promotion</p>
				<div class="amaz_running_ready_body2">
                    @foreach($more_products_get->getHomePageProductByQuery()->take(2) as $key => $product)
		...
		<div class="row mr_10_im">
			<div class="col-xl-12 col-md-12 col-lg-12 col-xm-12 bg_yellow" >
				<ul class="text_marquee owl-carousel owl-loaded owl-drag ">
					<li>first time free delivery in india</li>
					<li>Summer lookbook flash sale 70% off</li>
					<li>20% off everything for women</li>
					<li>first time free delivery in india</li>
					<li>Summer lookbook flash sale 70% off</li>
					<li>20% off everything for women</li>
				</ul>
