...
class Session {
	...
	/**#@+
	 * @see \WpOrg\Requestssession()->request()
	 * @param string $url
	 * @param array $headers
	 * @param array $options
	 ...
	 *
	 * Note: Unlike {@see \WpOrg\Requestssession()->post()} and {@see \WpOrg\Requestssession()->put()},
	 ...
	 *
	 * @param array $request Request data (same form as {@see \WpOrg\Requestssession()->request_multiple()})
