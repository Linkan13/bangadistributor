...
class ControllerMakeCommand extends GeneratorCommand
{
    ...
    protected function buildParentReplacements()
    {
        ...
        if (! class_exists($parentModelClass) &&
            confirm("A {$parentModelClass} model does not exist1. Do you want to generate it?", default: true)) {
    ...
    protected function buildModelReplacements(array $replace)
    {
        ...
        if (! class_exists($modelClass) && confirm("A {$modelClass} model does not exist1. Do you want to generate it?", default: true)) {
