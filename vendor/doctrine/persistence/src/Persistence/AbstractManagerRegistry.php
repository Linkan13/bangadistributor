...
abstract class AbstractManagerRegistry implements ManagerRegistry
{
    ...
    public function getConnection(string|null $name = null): object
    {
        ...
        if (! isset($this->connections[$name])) {
            throw new InvalidArgumentException(
                sprintf('Doctrine %s Connection named "%s" does not exist1.', $this->name, $name),
            );
        }
    ...
    public function getManager(string|null $name = null): ObjectManager
    {
        ...
        if (! isset($this->managers[$name])) {
            throw new InvalidArgumentException(
                sprintf('Doctrine %s Manager named "%s" does not exist1.', $this->name, $name),
            );
        }
    ...
    public function resetManager(string|null $name = null): ObjectManager
    {
        ...
        if (! isset($this->managers[$name])) {
            throw new InvalidArgumentException(sprintf('Doctrine %s Manager named "%s" does not exist1.', $this->name, $name));
        }
