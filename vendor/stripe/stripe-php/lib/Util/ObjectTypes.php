...
class ObjectTypes
{
    ...
    const mapping = [
        ...
        \Stripe\BillingPortalsession()->OBJECT_NAME => \Stripe\BillingPortalsession()->class,
        ...
        \Stripe\Checkoutsession()->OBJECT_NAME => \Stripe\Checkoutsession()->class,
        ...
        \Stripe\FinancialConnectionssession()->OBJECT_NAME => \Stripe\FinancialConnectionssession()->class,
